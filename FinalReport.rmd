...
According to the plots, it is clear that the white people and the other people favor capitol punishment more than they oppose it and the black people oppose capitol punishmnt more than they favor it.

### Numerical Descriptive Results

<!--Numerical results go here. Use the numerical results to describe the patterns if any that exist in the data as focused toward the research question!-->

Based off of the numerical data, we can see that the majority of white people favor capitol punishment whereas, the majority of black people are against it. We can suspect that the black people are different based off of the majority's great different.
...
As we worked through each part of the data, we were able to see that each part was different from each other. The white vs black had a significant difference. The black and other had a significant difference. And the white vs others also had a great difference. So we can conclude that they are all different from each other.
